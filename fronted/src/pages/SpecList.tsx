...
import { FileText, Sparkles, ShieldCheck, Plus } from 'lucide-react'
  ...
  return (
    <div>
      <PageHeader
        ...
        extra={<Button size="sm" className="bg-indigo-600 hover:bg-indigo-700"><Plus className="w-4 h-4 mr-1" />新增规格</Button>}
      />
